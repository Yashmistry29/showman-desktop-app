      ...
      <table className='mv3 mh2 w-100 font'>
        <tbody>
          ...
          <tr>
            <td rowSpan={4} colSpan={4}>
              <div className='mv4 mh2'>
                <pre className='f5-xl ma1'><span className='b'>Job Id</span>{`\t: ${jobData.job_id}\t\t`}<span className='b'>Customer Id</span>{`\t: ${customerData.c_id}`}</pre>
                <pre className='f5-xl ma1'><span className='b'>Name</span>{`\t: ${customerData.name}`}</pre>
                <pre className='f5-xl ma1'><span className='b'>Address</span>{`\t: ${customerData.address}`}</pre>
                <pre className='f5-xl ma1'><span className='b'>Mobile</span>{`\t: ${customerData.phone}, ${customerData.phone2}`}</pre>
              </div>
              {/* <div className='tc mb0 mt2'>
          ...
          <td colSpan={3} rowSpan={7}>
            ...
            <div className='tc font'>
              <p className='f1 center mv0'>SHOWMAN</p>
              <p className='f4 ls ml4 mv0'>TAILORS</p>
              <p className='mt2 mb0 b'>પેન્ટ શર્ટ સફારી સૂટ ના સ્પેશિયાલિસ્ટ</p>
                </div>
            <div className='mv4 mh2'>
              <p className='f4-xl ma1 tl'><span className='b'>Name: </span>{`${customerData.name} (${customerData.c_id})`}</p>
              <pre className='f4-xl ma1'>{`Job No.:${jobData.job_id}નામ: ${customerData.name} (${customerData.c_id})`}</pre>
              <pre className='f4-xl ma1'>{`ગામ: ${customerData.address}`}</pre>
              <pre className='f4-xl ma1'>{`ફોન નં: ${customerData.phone}, ${customerData.phone2}`}</pre>
                </div>
